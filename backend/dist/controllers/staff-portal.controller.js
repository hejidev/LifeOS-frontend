...
exports.getTeam = exports.clockOut = exports.getActivity = exports.logActivity = void 0;
const errors_1 = require("../lib/errors");
const staffPortalService = __importStar(require("../services/staff-portal.service"));
...
exports.clockOut = (0, errors_1.asyncHandler)(async (req, res) => {
    await staffPortalService.clockOut(req.staff.staffId, req.staff.bizProfileId);
    return res.status(204).send();
});
exports.getTeam = (0, errors_1.asyncHandler)(async (req, res) => {
