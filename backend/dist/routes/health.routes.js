...
router.post("/health/log", (0, validate_middleware_1.validate)(health_validator_1.logHealthSchema), healthController.logHealth);
router.get("/health/habits", healthController.getHabits);
router.post("/health/habits", (0, validate_middleware_1.validate)(health_validator_1.createHabitSchema), healthController.createHabit);
