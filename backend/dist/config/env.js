...
const envSchema = zod_1.z.object({
    ...
    PAYSTACK_PLAN_STARTER_MONTHLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_STARTER_YEARLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_PRO_MONTHLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_PRO_YEARLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_PREMIUM_MONTHLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_PREMIUM_YEARLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_MERCHANT_STARTER_MONTHLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_MERCHANT_STARTER_YEARLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_MERCHANT_GROWTH_MONTHLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_MERCHANT_GROWTH_YEARLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_MERCHANT_PRO_MONTHLY: zod_1.z.string().min(1),
    PAYSTACK_PLAN_MERCHANT_PRO_YEARLY: zod_1.z.string().min(1),
