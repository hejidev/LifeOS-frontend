    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
      ...
      <motion.div variants={item} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-2">Manage your team, roles, and access permissions</p>
        </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-blue-900 mt-1">{staff.length}</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-red-900 mt-1">{suspendedCount}</p>
              </div>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-2">
                            <div className={`p-2 rounded-lg ${ROLE_COLORS[s.role as keyof typeof ROLE_COLORS]}`}>
                              <RoleIcon className="h-4 w-4" />
                            </div>
                            <div className="min-w-0">
                              <h3 className="font-semibold text-base truncate">{s.name}</h3>
                              <div className="flex items-center gap-2 mt-1">
                                <Badge className={`text-xs ${ROLE_COLORS[s.role as keyof typeof ROLE_COLORS]}`}>
                                  {s.role.replace("_", " ")}
                                </Badge>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Create a new staff account and assign their role</DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="space-y-4 pt-4">
            <Tabs defaultValue="basic" className="w-full">
              ...
              <TabsContent value="basic" className="space-y-4 mt-4">
                ...
                <div className="space-y-2">
                  <Label>POS PIN (4–6 digits) *</Label>
                  <Input 
                    value={form.pin} 
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Update staff information and credentials</DialogDescription>
          </DialogHeader>
          <form onSubmit={handleEditSubmit} className="space-y-4 pt-4">
            <Tabs defaultValue="basic" className="w-full">
              ...
              <TabsContent value="basic" className="space-y-4 mt-4">
                ...
                <div className="space-y-2">
                  <Label>New POS PIN (leave blank to keep current)</Label>
                  <Input 
                    value={form.pin} 
                    onChange={(e) => setForm((f) => ({ ...f, pin: e.target.value.replace(/\D/g, "") }))} 
                    maxLength={6} 
